...
public class CompleteUnitySetup : MonoBehaviour
{
    ...
    private static void SetupMainScene()
    {
        ...
        if (mainManager == null)
        {
            Debug.LogError("MainScene에 MainMenuManager가 없습니다!");
            return;
        }
    ...
    private static void SetupCharacterSelectScene()
    {
        ...
        // CharacterSelectManager GameObject 생성
    ...
    private static void CreateCharacterSelectUI(Transform canvasTransform, CharacterSelectManager manager)
    {
        // 캐릭터 바 영역 (상단)
